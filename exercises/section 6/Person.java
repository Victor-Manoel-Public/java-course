  ...
  NOTE: In total, you have to write 8 methods.
    ...
    public static class Person {
        ...
        public String getFullName() {
            ...
            return (this.firstName.isEmpty() && this.lastName.isEmpty()) ? "" : (this.firstName.isEmpty()) ?
                    this.lastName : (this.lastName.isEmpty()) ? this.firstName : this.firstName + " " + this.lastName;
        }
    }
