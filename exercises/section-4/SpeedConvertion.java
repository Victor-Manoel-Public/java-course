    ...
    * */
    public static void printConversion(double kilometresPerHour){
        if(kilometresPerHour < 0){
            ...
            double milesPerHour = (Math.round(kilometresPerHour / 1.609));
            System.out.println(kilometresPerHour + " km/h = " + Math.round(milesPerHour) + " mi/h");
        }
    }
